...
float32 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_d2H3h12fBI3f().pack(_x.drone_time, _x.tag, _x.size, _x.mx, _x.my, _x.mz, _x.magneto_raw.x, _x.magneto_raw.y, _x.magneto_raw.z, _x.magneto_rectified.x, _x.magneto_rectified.y, _x.magneto_rectified.z, _x.magneto_offset.x, _x.magneto_offset.y, _x.magneto_offset.z, _x.heading_unwrapped, _x.heading_gyro_unwrapped, _x.heading_fusion_unwrapped, _x.magneto_calibration_ok, _x.magneto_state, _x.magneto_radius, _x.error_mean, _x.error_var))
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_d2H3h12fBI3f = None
def _get_struct_d2H3h12fBI3f():
    global _struct_d2H3h12fBI3f
    if _struct_d2H3h12fBI3f is None:
        _struct_d2H3h12fBI3f = struct.Struct("<d2H3h12fBI3f")
    return _struct_d2H3h12fBI3f
