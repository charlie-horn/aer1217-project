...
class Cluster():
    def __init__(self):
        ...
        self.threshold = 0.3 # default distance threshold
        self.minPts = 10 # minimum number of points in cluster
        return

    def cluster(self, locations, threshold, minPts):
        self.minPts = minPts
        ...
        for i in range(len(locations)): # go through each point
            ...
            found = False # flag indicates if the cluster is found
