...
float32 y"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_d2Hif2i5fI2fI().pack(_x.drone_time, _x.tag, _x.size, _x.altitude_vision, _x.altitude_vz, _x.altitude_ref, _x.altitude_raw, _x.obs_accZ, _x.obs_alt, _x.obs_x.x, _x.obs_x.y, _x.obs_x.z, _x.obs_state, _x.est_vb.x, _x.est_vb.y, _x.est_state))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.drone_time, _x.tag, _x.size, _x.altitude_vision, _x.altitude_vz, _x.altitude_ref, _x.altitude_raw, _x.obs_accZ, _x.obs_alt, _x.obs_x.x, _x.obs_x.y, _x.obs_x.z, _x.obs_state, _x.est_vb.x, _x.est_vb.y, _x.est_state,) = _get_struct_d2Hif2i5fI2fI().unpack(str[start:end])
      return self
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_d2Hif2i5fI2fI = None
def _get_struct_d2Hif2i5fI2fI():
    global _struct_d2Hif2i5fI2fI
    if _struct_d2Hif2i5fI2fI is None:
        _struct_d2Hif2i5fI2fI = struct.Struct("<d2Hif2i5fI2fI")
    return _struct_d2Hif2i5fI2fI
