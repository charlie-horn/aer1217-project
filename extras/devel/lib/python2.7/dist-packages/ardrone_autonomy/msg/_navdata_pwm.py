...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.drone_time, _x.tag, _x.size, _x.motor1, _x.motor2, _x.motor3, _x.motor4, _x.sat_motor1, _x.sat_motor2, _x.sat_motor3, _x.sat_motor4, _x.gaz_feed_forward, _x.gaz_altitude, _x.altitude_integral, _x.vz_ref, _x.u_pitch, _x.u_roll, _x.u_yaw, _x.yaw_u_I, _x.u_pitch_planif, _x.u_roll_planif, _x.u_yaw_planif, _x.u_gaz_planif, _x.current_motor1, _x.current_motor2, _x.current_motor3, _x.current_motor4, _x.altitude_der,) = _get_struct_d2H8B4f3if3if4Hf().unpack(str[start:end])
      return self
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_d2H8B4f3if3if4Hf = None
def _get_struct_d2H8B4f3if3if4Hf():
    global _struct_d2H8B4f3if3if4Hf
    if _struct_d2H8B4f3if3if4Hf is None:
        _struct_d2H8B4f3if3if4Hf = struct.Struct("<d2H8B4f3if3if4Hf")
    return _struct_d2H8B4f3if3if4Hf
