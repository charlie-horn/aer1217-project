...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_d2H().pack(_x.drone_time, _x.tag, _x.size))
      length = len(self.raw_gyros)
      buff.write(_struct_I.pack(length))
      pattern = '<%sh'%length
      buff.write(struct.Struct(pattern).pack(*self.raw_gyros))
      length = len(self.raw_gyros_110)
      buff.write(_struct_I.pack(length))
      pattern = '<%sh'%length
      buff.write(struct.Struct(pattern).pack(*self.raw_gyros_110))
      _x = self
      buff.write(_get_struct_I9HIih().pack(_x.vbat_raw, _x.us_debut_echo, _x.us_fin_echo, _x.us_association_echo, _x.us_distance_echo, _x.us_courbe_temps, _x.us_courbe_valeur, _x.us_courbe_ref, _x.flag_echo_ini, _x.nb_echo, _x.sum_echo, _x.alt_temp_raw, _x.gradient))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.drone_time, _x.tag, _x.size,) = _get_struct_d2H().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sh'%length
      ...
      self.raw_gyros = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sh'%length
      ...
      self.raw_gyros_110 = s.unpack(str[start:end])
      _x = self
      start = end
      end += 32
      (_x.vbat_raw, _x.us_debut_echo, _x.us_fin_echo, _x.us_association_echo, _x.us_distance_echo, _x.us_courbe_temps, _x.us_courbe_valeur, _x.us_courbe_ref, _x.flag_echo_ini, _x.nb_echo, _x.sum_echo, _x.alt_temp_raw, _x.gradient,) = _get_struct_I9HIih().unpack(str[start:end])
      return self
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_I9HIih = None
def _get_struct_I9HIih():
    global _struct_I9HIih
    if _struct_I9HIih is None:
        _struct_I9HIih = struct.Struct("<I9HIih")
    return _struct_I9HIih
_struct_d2H = None
def _get_struct_d2H():
    global _struct_d2H
